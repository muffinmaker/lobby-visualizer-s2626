const SECTIONS = [
  ...
  },
  {
    ...
    body: `
      ...
      <p><strong>Logo</strong> — choose a single <strong>Image</strong>, or a <strong>Pack</strong> (e.g. Pride symbols). <strong>Scale %</strong> and <strong>Opacity %</strong> apply to both. Pack: use <strong>◀ Prev</strong> / <strong>Next ▶</strong> or keyboard <kbd>[</kbd> <kbd>]</kbd> to step symbols; <strong>Pack drift</strong> auto-cycles with its own <strong>Pack drift speed</strong> slider. Toggle <strong>Show pack text</strong> to display symbol meaning text that auto-syncs to the current pack logo.</p>
    `,
  },
];
